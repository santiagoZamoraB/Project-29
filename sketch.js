...
function setup() {
  ...
  //level one
  block1 = new Block(700,275,30,40);
  //console.log(block1);
  block2 = new Block(730,275,30,40);
  block3 = new Block(760,275,30,40);
  block4 = new Block(790,275,30,40);
  block5 = new Block(820,275,30,40);
  block6 = new Block(850,275,30,40);
  block7 = new Block(880,275,30,40);
  //level two
  block8 = new Block(730,235,30,40);
  block9 = new Block(760,235,30,40);
  block10 = new Block(790,235,30,40);
  block11 = new Block(820,235,30,40);
  block12 = new Block(850,235,30,40);
  //level three
  block13 = new Block(760,195,30,40);
  block14 = new Block(790,195,30,40);
  block15 = new Block(820,195,30,40);
  //top
  block16 = new Block(790,155,30,40);
